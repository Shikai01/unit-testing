...
import hashlib
from secure_all.storage.access_register import AccessRegister
...
class AccessKey:
    ...
    def store_access(self):
        """guardar el access en el access store"""
        access_code = AccessRegister()
        access_code.save_access(self)
